...
extern NSString * const ImageNamedOptions1x;
extern NSString * const ImageNamedOptions2x;
extern NSString * const ImageNamedOptions568h;
extern NSString * const ImageNamedOptionsAny;
extern NSString * const ImageNamedOptionsIpad;
