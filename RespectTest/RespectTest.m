...
- (void)testRespect {
    ...
    for (PBXNativeTarget *nativeTarget in pbxProject.targets) {
        ...
        XCBuildConfiguration *buildConfiguration = nativeTarget.buildConfigurationList.buildConfigurations[0];
            ...
            [[NSRegularExpression
             ...
             ^(NSTextCheckingResult *result, NSMatchingFlags flags, BOOL *stop) {
                 ...
                 if ([type isEqualToString:@"Unused"]) {
                     ...
                     NSMutableSet *issues = (*fileIssues)[filename];
                     if (issues == nil) {
                         issues = [NSMutableSet set];
                         (*fileIssues)[filename] = issues;
                     }
        ...
        for (LintWarning *lintWarning in linter.lintWarnings) {
            ...
            NSMutableSet *warnings = actualWarnings[relativePath];
            if (warnings == nil) {
                warnings = [NSMutableSet set];
                actualWarnings[relativePath] = warnings;
            }
        ...
        for (ConfigError *configError in linter.configErrors) {
            ...
            NSMutableSet *errors = actualConfigErrors[relativePath];
            if (errors == nil) {
                errors = [NSMutableSet set];
                actualConfigErrors[relativePath] = errors;
            }
        ...
        for (LintError *lintError in linter.lintErrors) {
            ...
            NSMutableSet *errors = actualLintErrors[relativePath];
            if (errors == nil) {
                errors = [NSMutableSet set];
                actualLintErrors[relativePath] = errors;
            }
        ...
        if (![expectedWarnings isEqualToDictionary:actualWarnings]) {
            ...
            for (NSString *resourcePath in expectedWarnings) {
                for (NSString *warning in expectedWarnings[resourcePath]) {
                    [messages addObject:[NSString stringWithFormat:@"  %@: %@\n",
            ...
            for (NSString *resourcePath in actualWarnings) {
                for (NSString *warning in actualWarnings[resourcePath]) {
                    [messages addObject:[NSString stringWithFormat:@"  %@: %@\n",
                                         resourcePath, warning]];
                }
            }
        ...
        if (![expectedConfigErrors isEqualToDictionary:actualConfigErrors]) {
            ...
            for (NSString *resourcePath in expectedConfigErrors) {
                for (NSString *error in expectedConfigErrors[resourcePath]) {
                    [messages addObject:[NSString stringWithFormat:@"  %@: %@\n",
                                         resourcePath, error]];
                }
            }
            ...
            for (NSString *resourcePath in actualConfigErrors) {
                for (NSString *error in actualConfigErrors[resourcePath]) {
                    [messages addObject:[NSString stringWithFormat:@"  %@: %@\n",
                                         resourcePath, error]];
                }
            }
        ...
        if (![expectedLintErrors isEqualToDictionary:actualLintErrors]) {
            ...
            for (NSString *resourcePath in expectedLintErrors) {
                for (NSString *error in expectedLintErrors[resourcePath]) {
                    [messages addObject:[NSString stringWithFormat:@"  %@: %@\n",
                                         resourcePath, error]];
                }
            }
            ...
            for (NSString *resourcePath in actualLintErrors) {
                for (NSString *error in actualLintErrors[resourcePath]) {
                    [messages addObject:[NSString stringWithFormat:@"  %@: %@\n",
                                         resourcePath, error]];
                }
            }
        ...
        for (Class reportClass in @[[ResourceLinterCliReport class],
